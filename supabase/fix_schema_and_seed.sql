...
('FIFA World Cup 2026', 'FIFA World Cup 2026', 'FIFA World Cup 2026', 'Jun 11 – Jul 19, 2026', '5B+ cumulative TV viewers', 'First 48-team format, hosted across US, Mexico, Canada. 16 host cities, 104 matches over 39 days.', 'CRITICAL – Secure partnerships 12+ months ahead', 2026, ARRAY['Largest sporting event in history','$11B+ economic impact','48 teams, 16 cities across 3 countries','Est. 5M+ in-person attendees'], 'Tier 1', 'The biggest single sporting event in history, co-hosted by USA, Mexico, and Canada.', '["Global audience", "18-55", "Male skew", "Sports fans", "Hispanic/Latino", "Soccer culture"]'::jsonb),
('Summer Olympics 2028 (LA)', 'Summer Olympics 2028 (LA)', 'Summer Olympics 2028 (LA)', 'Jul 14 – Jul 30, 2028', '3.5B+ cumulative viewers', 'Los Angeles hosts for 3rd time. 35+ sports, 300+ events. Opening ceremony at SoFi Stadium.', 'Begin planning now for 2028 activations', 2028, ARRAY['First LA Olympics since 1984','35 sports, 300+ events','SoFi Stadium opening ceremony','$7B+ economic impact projected'], 'Tier 1', 'The 2028 Summer Olympics returns to Los Angeles.', '["Global audience", "All ages", "Athletes", "National pride"]'::jsonb),
...
('Grammy Awards 2026', 'Grammy Awards 2026', 'Grammy Awards 2026', 'Feb 1, 2026', '12M+ US viewers, 200M+ social', 'Music''s biggest night. Red carpet, performances, after-parties. Major moment for music brand partnerships.', 'MODERATE – Align with nominee campaigns 2-3 months ahead', 2026, ARRAY['12M+ US viewers','200M+ social media impressions','Red carpet fashion moment','Music partnership peak'], 'Tier 1', 'The premier music awards ceremony.', '["Music fans", "18-45", "All genders", "Pop culture enthusiasts"]'::jsonb),
('VidCon 2026', 'VidCon 2026', 'VidCon 2026', 'Jun 25–28, 2026', '55K+ attendees', 'The premier creator economy event. Three tracks: Community, Creator, Industry. Major brand-creator matchmaking.', 'HIGH – Creator partnerships should be secured 3+ months ahead', 2026, ARRAY['55,000+ attendees','#1 creator economy conference','Three tracks: Community, Creator, Industry','Major brand activation venue'], 'Tier 1', 'The largest event dedicated to online video creators and their fans.', '["Creators", "Gen Z", "13-30", "Digital natives", "Brand marketers"]'::jsonb),
