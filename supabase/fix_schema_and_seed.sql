...
-- ============================================================
INSERT INTO demographic_segments (title, name, description, age_range, gender, income_range, interests, platforms, size_estimate, population_size, buying_power, media_preferences, top_events, key_cultural_moments, brand_activation_tips, activation_tips, best_demographics) VALUES
('Gen Z Trendsetters', 'Gen Z Trendsetters', 'Fashion and culture-forward Gen Z consumers who drive viral trends', '18-26', 'all', '$25K-$50K', ARRAY['fashion','music','gaming','social justice','beauty'], ARRAY['tiktok','instagram','youtube'], 68000000, '68M (US)', '$360B annually', ARRAY['Short-form video','Memes & viral content','Podcasts','Live streams'], ARRAY['Pride Month','Coachella','ComplexCon','VidCon','Met Gala'], ARRAY['Social justice movements','Cancel culture awareness','Sustainable fashion','Body positivity','Mental health advocacy'], ARRAY['Authentic over polished — raw content wins','Use TikTok-first strategies','Partner with micro-creators for trust','Lead with values and social impact','Enable UGC and challenges'], ARRAY['Authentic over polished — raw content wins','Use TikTok-first strategies','Partner with micro-creators for trust'], ARRAY['Gen Z','18-26','Digital natives','Trend-forward']),
