...
Deno.serve(async (req) => {
  try {
    ...
    const prompt = `You are an expert executive briefing analyst for a partnership and influencer management platform called PartnerIQ. Generate a comprehensive executive briefing report based on the following data.
