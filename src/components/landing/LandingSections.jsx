...
const FAQ_DATA = [
  ...
  { q: "How does AI matching work?", a: "Our Match Engine uses 10 weighted factors: audience demographic overlap (25%), niche alignment (20%), engagement quality (15%), brand safety (10%), budget fit (10%), deal history (8%), audience authenticity (5%), geographic match (4%), competitor conflicts (2%), and growth trajectory (1%). This produces a match score with 94% accuracy." },
