  ...
  return (
    <>
      ...
      <style>{`
        ...
        .ds-nav-link {
          font-size: 0.82rem; color: var(--ds-gold); text-decoration: none;
          ...
          background: none; border: none; cursor: pointer; font-family: var(--ds-sans); font-weight: 400;
        }
        .ds-nav-link:hover { color: var(--ds-amber); }
        ...
        .ds-btn-demo { font-size: 0.82rem; font-weight: 500; color: var(--ds-gold); border: 0.5px solid var(--ds-gold); border-radius: 5px; padding: 0.45rem 1rem; background: none; cursor: pointer; text-decoration: none; transition: border-color 0.2s, background 0.2s, color 0.2s; white-space: nowrap; font-family: var(--ds-sans); }
        ...
        .ds-btn-ghost {
          font-family: var(--ds-sans); font-size: 0.82rem; color: var(--ds-gold); font-weight: 500;
          background: none; border: none; cursor: pointer; text-decoration: none;
          transition: color 0.2s; white-space: nowrap;
        }
        .ds-btn-ghost:hover { color: var(--ds-amber); }
        .ds-btn-trial {
