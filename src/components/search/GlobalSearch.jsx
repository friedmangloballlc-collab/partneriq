    ...
    <div className="relative w-full max-w-md">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-16 py-2 border border-border rounded-lg text-sm bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
        />
        {!searchTerm && (
              ...
              {results.industries.length > 0 && (
                <div className="border-b border-border">
                  ...
                  {results.industries.map((industry) => (
                    ...
                    >
                      <div className="font-medium text-foreground">{industry.industry}</div>
