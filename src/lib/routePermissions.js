...
const rolePages = {
  ...
  brand: new Set([
    ...
    'CustomReports', 'Outreach', 'SequenceBuilder', 'Approvals', 'MatchEngine',
  ...
  talent: new Set([
    ...
    'MarketIntelligence', 'Brands', 'Partnerships', 'DealAnalytics', 'CustomReports',
    'TalentAnalytics', 'TalentRevenue', 'Outreach', 'SequenceBuilder', 'Approvals', 'MatchEngine',
    ...
    'Settings', 'Analytics', 'SubscriptionManagement',
  ]),
  agency: new Set([
