...
const rolePages = {
  ...
  brand: new Set([
    ...
    'DealScoreLeaderboard', 'TalentDataRoom', 'BrandDataRoom', 'AgencyDataRoom', 'DealDetail', 'CustomReports',
    'Outreach', 'SequenceBuilder', 'Approvals', 'MatchEngine',
    ...
    'Integrations', 'BillingHistory', 'Settings', 'Notifications', 'Analytics',
    'Brands', 'ContactFinder', 'ContractTemplates', 'Referrals', 'DeckLibrary',
    'CreateOpportunity', 'SubscriptionManagement', 'ConnectAccounts', 'EventManagement',
    'BundleDeals', 'PitchCompetition', 'WarmIntroNetwork',
  ]),
  talent: new Set([
    'Dashboard', 'PlatformOverview', 'AIFeatures', 'AIAgentsHub', 'AICommandCenter',
    ...
    'WarmIntroNetwork', 'PitchCompetition', 'BundleDeals',
    'ContractTemplates', 'Referrals', 'DeckLibrary', 'EventManagement',
    'DataImportExport', 'SimulationEngine',
  ]),
  manager: new Set([
