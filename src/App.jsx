...
const PUBLIC_ROUTES = [
  { paths: ['/terms', '/Terms'], component: Terms },
  { paths: ['/privacy', '/Privacy'], component: Privacy },
  { paths: ['/calculator', '/CreatorCalculator'], component: CreatorCalculator },
  { paths: ['/pricing', '/Pricing'], component: Pricing },
  { paths: ['/faq', '/FAQ'], component: React.lazy(() => import('@/pages/FAQ')) },
  { paths: ['/about', '/About'], component: PAGES.About },
  { paths: ['/blog', '/Blog'], component: PAGES.Blog },
  { paths: ['/careers', '/Careers'], component: PAGES.Careers },
  { paths: ['/contact', '/Contact'], component: PAGES.Contact },
  { paths: ['/customers', '/Customers'], component: PAGES.Customers },
  { paths: ['/cookie-policy', '/CookiePolicy'], component: PAGES.CookiePolicy },
  { paths: ['/gdpr', '/GDPR'], component: PAGES.GDPR },
  { paths: ['/demo', '/Demo'], component: PAGES.Demo },
  { paths: ['/login', '/Login'], component: Login },
  { paths: ['/features/talent-discovery', '/FeatureTalentDiscovery'], component: FeatureTalentDiscovery },
  { paths: ['/features/deal-pipeline', '/FeatureDealPipeline'], component: FeatureDealPipeline },
  { paths: ['/features/media-kits', '/FeatureMediaKits'], component: FeatureMediaKits },
  { paths: ['/features/payments', '/FeaturePayments'], component: FeaturePayments },
  { paths: ['/features/integrations', '/FeatureIntegrations'], component: FeatureIntegrations },
  { paths: ['/features/campaign-analytics', '/FeatureCampaignAnalytics'], component: FeatureCampaignAnalytics },
  { paths: ['/features/send-deals', '/FeatureSendDeals'], component: FeatureSendDeals },
  { paths: ['/features/manage-deals', '/FeatureManageDeals'], component: FeatureManageDeals },
  { paths: ['/features/browse-talent', '/FeatureBrowseTalent'], component: FeatureBrowseTalent },
  { paths: ['/features/manage-talent', '/FeatureManageTalent'], component: FeatureManageTalent },
  { paths: ['/for-managers', '/ForManagers'], component: ForManagers },
  { paths: ['/vs-grin', '/CompareGrin'], component: CompareGrin },
  { paths: ['/vs-aspire', '/CompareAspire'], component: CompareAspire },
  { paths: ['/vs-creatoriq', '/CompareCreatorIQ'], component: CompareCreatorIQ },
];
