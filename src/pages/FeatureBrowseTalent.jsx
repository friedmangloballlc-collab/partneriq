      ...
      <div style={{ padding: "16px 24px", borderBottom: `1px solid ${T.borderAlt}`, display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
        {["All Categories", "Athletes", "Creators", "Musicians", "Models", "Podcasters"].map((cat, i) => (
          <span key={i} style={{
            ...
            background: i === 0 ? `linear-gradient(135deg, ${T.gold}, ${T.amber})` : "rgba(196,162,74,0.08)",
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 24px 0" }}>
        <Fade>
          <div style={{ maxWidth: 600, margin: "0 auto", padding: "2rem", textAlign: "center", borderLeft: "2px solid #c4a24a", background: "rgba(196,162,74,0.03)", borderRadius: "0 8px 8px 0" }}>
            ...
            <p style={{ fontSize: "0.75rem", color: "#c4a24a", fontFamily: "'Instrument Mono', monospace" }}>— Brand Marketing Director</p>
          </div>
        </Fade>
      </section>
