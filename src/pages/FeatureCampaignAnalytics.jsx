        ...
        <div style={{ background: T.bgCardAlt, border: `1px solid ${T.borderAlt}`, borderRadius: 12, overflow: "hidden" }}>
          ...
          {TOP_CREATORS.map((creator, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", borderBottom: i < TOP_CREATORS.length - 1 ? `1px solid ${T.borderAlt}` : "none" }}>
              ...
              <span style={{ ...mono, fontSize: 10, color: T.creamDim, padding: "3px 8px", background: "rgba(196,162,74,0.08)", borderRadius: 4 }}>{creator.platform}</span>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 24px 0" }}>
        <Fade>
          <div style={{ maxWidth: 600, margin: "0 auto", padding: "2rem", textAlign: "center", borderLeft: "2px solid #c4a24a", background: "rgba(196,162,74,0.03)", borderRadius: "0 8px 8px 0" }}>
            ...
            <p style={{ fontSize: "0.75rem", color: "#c4a24a", fontFamily: "'Instrument Mono', monospace" }}>— VP Marketing, DTC Brand</p>
          </div>
        </Fade>
      </section>
