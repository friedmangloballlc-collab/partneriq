...
const PLANS_BY_ROLE = {
  talent: subscriptionToOnboarding(TALENT_PLANS),
  brand: subscriptionToOnboarding(BRAND_PLANS),
  agency: subscriptionToOnboarding(AGENCY_PLANS),
  manager: subscriptionToOnboarding(MANAGER_PLANS),
};
